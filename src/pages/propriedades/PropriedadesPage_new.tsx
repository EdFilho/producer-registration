...
import { fetchPropriedadesByProdutor, deletePropriedade } from '../../store/propriedadeRuralSlice';
...
const PropriedadesPage: React.FC = () => {
  ...
  const getPropriedadeSafras = (propriedadeId: string) => {
    return safras.filter(safra => safra.propriedadeRuralId === propriedadeId);
  };
          ...
          return (
            ...
            >
              ...
              <div style={{ marginBottom: '1rem' }}>
                ...
                <p style={{ margin: '0.5rem 0' }}>
                  <strong>Área Total:</strong> {propriedade.areaTotalHectares} ha
                </p>
                <p style={{ margin: '0.5rem 0' }}>
                  <strong>Área Agricultável:</strong> {propriedade.areaAgricultavelHectares} ha
                </p>
                <p style={{ margin: '0.5rem 0' }}>
                  <strong>Área de Vegetação:</strong> {propriedade.areaVegetacaoHectares} ha
                </p>
                <p style={{ margin: '0.5rem 0' }}>
                          ...
                          {safra.culturasPlantadas.length > 0 ? (
                            <div>
                              ...
                              <div style={{ display: 'flex', flexWrap: 'wrap', gap: '0.5rem' }}>
                                {safra.culturasPlantadas.map((cultura, index) => (
                                  <span
                                    key={index}
                                    style={{
      ...
      <div style={{ padding: '2rem', maxWidth: '1200px', margin: '0 auto' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '2rem' }}>
          ...
          <h1 style={{ margin: 0, color: '#495057' }}>
            Fazendas de {currentProducer?.nomeProdutor || 'Carregando...'}
          </h1>
          <ActionButton
            variant="primary"
